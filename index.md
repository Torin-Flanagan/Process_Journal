...
**Here is the link to access the live web app:**
...
- Delayed Overlay Data: The real-time data presented in the overlays is somewhat delayed, meaning there is a lag in the updates of the location and speed, metrics. Despite efforts to optimise the speed of these updates, the delay persists due to limitations in the current prototype.
